...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cellpose-napari-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15431&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cellpose-napari-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cellpose-napari` can be installed with:

```
conda install cellpose-napari
```

It is possible to list all of the versions of `cellpose-napari` available on your platform with:
